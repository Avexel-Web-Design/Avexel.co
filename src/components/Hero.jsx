...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-36 pb-20 bg-dark">
      {/* Decorative Elements */}
      ...
      <div className="absolute bottom-0 left-0 w-full h-24 overflow-hidden">
        <svg viewBox="0 0 1200 120" className="absolute bottom-0 w-full h-24" preserveAspectRatio="none">
          <path d="M321.39,56.44c58-10.79,114.16-30.13,172-41.86,82.39-16.72,168.19-17.73,250.45-.39C823.78,31,906.67,72,985.66,92.83c70.05,18.48,146.53,26.09,214.34,3V120H0V95.8C59.71,118.92,130.83,141.49,195.07,153.86Z" className="fill-[#0a0f1e]/90"></path>
        </svg>
      </div>
    </section>
  );
