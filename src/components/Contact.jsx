...
const ContactInfo = ({ icon, title, content }) => (
  <div className="flex items-start gap-4">
    <div className="w-12 h-12 rounded-lg bg-gradient-to-br from-primary-500/20 to-secondary-500/20 flex items-center justify-center ring-1 ring-white/10">
...
const Contact = () => {
  return (
    <section id="contact" className="py-24 bg-gradient-to-b from-dark via-dark/95 to-dark scroll-mt-24">
      <div className="container mx-auto px-4 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto reveal">
          ...
          <div className="relative group">
            ...
            <div className="relative h-full bg-dark/80 backdrop-blur-sm p-8 lg:p-12 rounded-xl border border-white/10">
          ...
          <div className="relative group">
            <div className="absolute -inset-0.5 bg-gradient-to-r from-primary-500 to-secondary-500 rounded-2xl blur opacity-30 group-hover:opacity-100 transition duration-500"></div>
            <div className="relative bg-dark/80 backdrop-blur-sm p-8 lg:p-12 rounded-xl border border-white/10">
